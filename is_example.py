...
#####
# This is a custom 'getting started' script, made with care for acquiesce98@gmail.com.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="ZL5gwlhQqLT0MYCY04YKBiX8SVGJTH0r")
